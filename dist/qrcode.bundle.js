(self["webpackChunkwebpack_demo"] = self["webpackChunkwebpack_demo"] || []).push([["qrcode"],{
...
function createQrCode(canvas, vCard) {
  if (canvas) {
    ...
    qrcode__WEBPACK_IMPORTED_MODULE_0__.toCanvas(canvas, vCard, options, function (error) {
